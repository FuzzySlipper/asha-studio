...
test('studio agent voxel workflow surface stays typed and bounded', () => {
  ...
  for (const operation of ['inspect', 'register_conversion_source', 'register_conversion_mesh_asset', 'configure_conversion', 'run_conversion', 'get_model_info', 'export_voxel_volume_asset', 'view_from_angle', 'publish_preview', 'persist_voxel_asset', 'reopen_voxel_asset', 'submit_voxel_edit', 'submit_compact_voxel_edit']) {
