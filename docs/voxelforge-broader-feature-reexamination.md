...
| Screenshot/viewer capture | MCP visual tools and browser viewer capture. | Keep projection-only evidence. Do not treat screenshots or renderer-host picks/buffers as authority. | `codex-asha-studio` | No task now. |
