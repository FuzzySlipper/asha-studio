...
The workflow proof is `pnpm run proof:catalog-workflow-m3`. It must show the human-visible Catalog tab, create/load/link/validate affordances, bounded project-root file readback, and fail-closed diagnostics for missing source evidence and invalid/private catalog paths.
